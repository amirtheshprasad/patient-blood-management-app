<div class="my-10 flex justify-center w-full">
    <section class="border rounded shadow-lg p-5 w-6/12 bg-gray-100"">
        <h1 class="text-center text-3xl my-5">Log In</h1>
        <hr>
...
</div><?php /**PATH G:\Amirthesh\Documents\Projects\Laravel\Circle\patient-blood-management-app\resources\views/livewire/login.blade.php ENDPATH**/ ?>
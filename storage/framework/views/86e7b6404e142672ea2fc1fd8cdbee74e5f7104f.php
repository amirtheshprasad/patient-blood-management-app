...
} elseif ($_instance->childHasBeenRendered('PWsFYjV')) {
    $componentId = $_instance->getRenderedChildComponentId('PWsFYjV');
    $componentTag = $_instance->getRenderedChildComponentTagName('PWsFYjV');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PWsFYjV');
} else {
    $response = \Livewire\Livewire::mount('register', []);
    $html = $response->html();
    $_instance->logRenderedChild('PWsFYjV', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?> -->
...
</html><?php /**PATH G:\Amirthesh\Documents\Projects\Laravel\Circle\patient-blood-management-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>